      ...
      <div className="w-full max-w-lg bg-[#0A0A0A] border border-white/10 rounded-3xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
        <div className="relative p-8">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h3 className="text-xl font-display font-bold text-white tracking-tight">Edit Branch Details</h3>
              <p className="text-[10px] text-white/40 uppercase tracking-[0.2em] font-black mt-1">Facility Configuration Node</p>
            </div>
          </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <textarea
                    ...
                    required
                    rows={3}
                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-3 pl-12 pr-4 text-sm text-white focus:outline-none focus:border-primary/50 transition-all font-medium resize-none"
                  />
                </div>
